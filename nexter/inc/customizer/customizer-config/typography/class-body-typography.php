	...
	class Nexter_Body_Typography extends Nexter_Customizer_Config {
		...
		public function register_configuration( $configurations, $wp_customize ) {
			...
			$options = array(
				...
				array(
					'name'         => NXT_OPTIONS . '[typo-preview-body]',
					'type'         => 'control',
					...
					'settings'     => array(),
					'preview_text' => __( 'The quick brown fox jumps over the lazy dog.', 'nexter' ),
					'connect'      => array(
						'family'      => NXT_OPTIONS . '[body-font-family]',
						'weight'      => NXT_OPTIONS . '[body-font-weight]',
						'transform'   => NXT_OPTIONS . '[body-transform]',
						'size'        => NXT_OPTIONS . '[font-size-body]',
						'line-height' => NXT_OPTIONS . '[body-line-height]',
						'color'       => NXT_OPTIONS . '[body-color]',
